      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl shadow-slate-950/60 flex flex-col">
        ...
        <div className="px-6 py-4 bg-gradient-to-r from-slate-900 via-slate-850 to-slate-900 border-b border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-100">Firebase Staff Identity</h3>
              <p className="text-[11px] text-slate-400">Authenticated operator &amp; cloud sync</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          {currentUser ? (
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-slate-800/60 border border-slate-700/70 flex items-center gap-3">
                ...
                <div className="truncate flex-1">
                  ...
                  <div className="text-xs text-slate-400 truncate">
                    {currentUser.email || 'Staff Session'}
                  </div>
                  <div className="flex items-center gap-2 mt-1">
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-emerald-950 border border-emerald-700/60 text-emerald-300">
                      Station: {userProfile?.role || 'Active Operator'}
                    </span>
              ...
              <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800 text-xs text-slate-400 space-y-1">
                <div className="font-semibold text-slate-300">Role Discipline:</div>
                <div>Station roles are governed strictly at the station sign-in screen to ensure segregated duties.</div>
              </div>
            ...
            <div className="space-y-4">
              <div className="text-center space-y-1">
                ...
                <p className="text-xs text-slate-400">
                  Authenticate with Google to persist prescriptions, audit logs, and music playlists to Firestore.
                </p>
              </div>
